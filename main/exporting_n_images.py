...
filepath = '/media/lennart/Volume/Downloads/images'                             # filepath to folder with the images
hdf5_path = "/media/lennart/Volume/Downloads/10000images.hdf5"                     # name of hdf5 file to create
